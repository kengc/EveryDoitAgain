...
- (void)insertNewObject:(id)sender {
   ...
   // [self.tableView reloadData];
    ...
    ///////////// po pup
    //UITextField *myTextField;  //make a property
    
//    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Add a ToDo" message:@"" preferredStyle:UIAlertControllerStyleAlert];
//    
//    //[alert addTextFieldWithConfigurationHandler:^(UITextFIeld * _Nonull textfield)]
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([[segue identifier] isEqualToString:@"showAddView"]) {
        ...
        [controller setDetailItem:context];
        //controller.navigationItem.leftBarButtonItem = self.splitViewController.displayModeButtonItem;
        //controller.navigationItem.leftItemsSupplementBackButton = YES;
    }
...
- (NSFetchedResultsController<ToDo *> *)fetchedResultsController {
    ...
    NSSortDescriptor *sortDescriptor = [NSSortDescriptor sortDescriptorWithKey:@"todoTitle" ascending:NO];
